"""Processing text data with Spark (v2)

Alternative examples for text preprocessing workflows in Spark. Demonstrates tokenization,
stop-word removal, count-vectorization and basic text feature extraction.

Usage: set `JAVA_HOME` and run with Python where `pyspark` is installed.
"""

"""Read Parquet examples (v2)

Additional Parquet examples showing reading partitioned datasets and schema options.

Usage: set `JAVA_HOME` and run with Python + `pyspark` available.
"""

"""Delta Lake table examples

Shows how to create, write and time-travel Delta Lake tables using Spark and Delta.

Usage: ensure `pyspark` and `delta-spark` packages are available and `JAVA_HOME` is set.
"""
